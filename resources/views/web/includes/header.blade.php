                ...
                <div class="header-wrapper-1">
                    <div class="logo-area-start">
                        <a href="{{ route('home') }}" class="logo">
                            <img src="{{ URL::asset("assets/web/images/logo/logo.svg") }}" alt="logo_area">
                        </a>
                    </div>
                    <div class="header-right d-block">
                        <div class="top">
                            ...
                            <div class="right">
                                @include('web.includes.social-icons')
                            </div>
                        </div>
                        <div class="bottom d-flex align-items-center justify-content-between">
                            <div class="nav-area">
                                <ul class="">
                                    ...
                                    <li class="main-nav">
                                        <a class="main-menu" href="{{ route('most-sold') }}">
                                            {{ __("web.Most Sold") }}
                                        </a>
                                    </li>

                                    <li class="main-nav">
                                        <a class="main-menu" href="{{ route('about-us') }}">
                                            {{ __("web.About Us") }}
                                        </a>
                                    </li>

                                    <li class="main-nav">
                                        <a class="main-menu" href="{{ route('contact-us') }}">
                                            {{ __("web.Contact") }}
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <div class="bottom-right">
                                <div class="button-area">
                                    <a href="{{ route('login') }}" class="rts-btn btn-border radius-big icon">
                                        {{ __('web.Sign In') }}
                                    ...
                                    <a href="#" class="rts-btn btn-primary radius-big icon">
                                        {{ __('web.Add Order') }}
