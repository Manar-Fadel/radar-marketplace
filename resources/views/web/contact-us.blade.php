        ...
        <div class="rts-breadcrumb-area service jarallax">
            <div class="container">
                <div class="breadcrumb-area-wrapper">
                    <h1 class="title">{{ __('web.Get In Touch') }}</h1>
                    <div class="nav-bread-crumb">
                        <a href="index.html">{{ __('web.Home') }}</a>
                        <a href="#" class="current">{{ __('web.Contact') }}</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="section-inner d-flex">
                    ...
                    <div class="get-in-touch-area">
                        <div class="contact-form">
                            ...
                            <form class="form__content" method="post" action="{{ route('contact-us') }}" id="contact-form">
                                <div class="form__control">
                                    ...
                                    <input type="text" class="input-form" name="name" id="name" placeholder="{{ __('web.what is your name?') }}" required>
                                </div>
                                <div class="form__control">
                                        <span class="icon">
